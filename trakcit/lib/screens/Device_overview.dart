        ...
        actions: <Widget>[
          ...
          IconButton(
              onPressed: () {
                showSearch(
                    context: context,
                    delegate: MysearchDelegate(loaded_products: loadedDeviec));
              },
