                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Text(
                            'Device Id : ${wlab.id}',style: TextStyle(height: 5,fontSize: 15),
                          )
                        ],
                      ),
                      Text(
                        ...
                        children: [
                             ...
                             RichText(text: TextSpan(
                              children: [
                                ...
                                WidgetSpan(child: Icon(Icons.remove_red_eye,color: Theme.of(context).primaryColor,),),
                                TextSpan(
                                  text: "View Details  ",
                          ...
                          GestureDetector(
                            onTap: (){
                              Navigator.of(context).pushNamed(EditLabScreen.routeName,arguments: wlab.id );
                            },
                            child: RichText(text: TextSpan(
                              children:[
                                WidgetSpan(child: Icon(Icons.edit,color: Theme.of(context).primaryColor,),),
                                TextSpan(
                                  text: "Edit Details",
                                  style: TextStyle(color: Colors.black),
                                ),
