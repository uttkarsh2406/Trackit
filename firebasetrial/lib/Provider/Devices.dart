...
import 'package:firebasetrial/Provider/lab.dart';
import 'Device.dart';
import 'package:firebasetrial/Model/labadmin.dart';
  ...
  List<Device> _items = [
    Device(
      ...
      labdetail: Lab(
          ...
          labname: 'SSl',
          department: 'CSE',
          admin: LabAdmin(username: 'a', password: 'a')),
    ),
    Device(
      id: '124',
      name: 'Printer',
